  ...
  return (
    <div>
      ...
      <Section bg="bg-white">
        ...
        <h2 className="font-['Playfair_Display',serif] font-bold text-[26px] sm:text-[36px] lg:text-[44px] leading-tight text-[#1a1a2e] mt-3">Shoes That Keep Up With Kids</h2>
        <div className="mt-8 flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1">
            <p className="font-['Inter',sans-serif] text-[14px] sm:text-[16px] leading-[27px] text-[#4a4a5c]">{"Children's feet grow fast and need proper support. Our kids' footwear collection is selected for durability, correct fit and the styles kids actually want to wear."}</p>
            <div className="mt-7 grid grid-cols-2 gap-3">
              {[
                ...
                <div key={title} className="bg-[#f2ede4] rounded-xl p-4">
                  <p className="font-['Inter',sans-serif] font-semibold text-[13px] sm:text-[14px] text-[#1a1a2e]">{title}</p>
                  <p className="font-['Inter',sans-serif] text-[11px] sm:text-[12px] text-[#4a4a5c] mt-1">{desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <Section bg="bg-[#f2ede4]">
        ...
        <h2 className="font-['Playfair_Display',serif] font-bold text-[26px] sm:text-[36px] lg:text-[44px] leading-tight text-[#e40a7a] mt-3">Ready for School Day One</h2>
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <div key={title} className="bg-white rounded-2xl overflow-hidden shadow-sm">
              ...
              <div className="p-5">
                <p className="font-['Playfair_Display',serif] font-bold text-[17px] sm:text-[19px] text-[#1a1a2e]">{title}</p>
      ...
      <ParallaxBand img={imgColKids} className="py-12 sm:py-14" overlayOpacity={0.72}>
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 lg:px-10 text-center">
          <ScrollReveal>
            <p className="font-['Playfair_Display',serif] font-bold text-[22px] sm:text-[28px] text-white">Designed for How Kids Move</p>
          </ScrollReveal>
        </div>
      </ParallaxBand>
      ...
      <Section bg="bg-white">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-center">
          <div className="flex-1">
            ...
            <h2 className="font-['Playfair_Display',serif] font-bold text-[24px] sm:text-[34px] lg:text-[40px] leading-tight text-[#1a1a2e] mt-3">Designed for How Kids Actually Move</h2>
            <p className="font-['Inter',sans-serif] text-[14px] sm:text-[16px] leading-[27px] text-[#4a4a5c] mt-5">Children spend hours on their feet — at school, at play and at home. Our everyday collection focuses on cushioning, flexibility and durability so feet stay comfortable all day.</p>
            <div className="mt-7 flex flex-col gap-3">
              {[
                ...
                <div key={t} className="flex gap-3 items-start">
                  <div className="w-2 h-2 rounded-full bg-[#d10b78] shrink-0 mt-2"/>
                  <div>
                    <span className="font-['Inter',sans-serif] font-semibold text-[13px] sm:text-[14px] text-[#1a1a2e]">{t}: </span>
                    <span className="font-['Inter',sans-serif] text-[13px] sm:text-[14px] text-[#4a4a5c]">{d}</span>
                  </div>
                </div>
              ))}
            </div>
      ...
      <Section bg="bg-[#faf7f2]">
        ...
        <h2 className="font-['Playfair_Display',serif] font-bold text-[24px] sm:text-[34px] lg:text-[40px] leading-tight text-[#1a1a2e] mt-3">Kids Collection Pricing</h2>
        <p className="font-['Inter',sans-serif] text-[14px] sm:text-[15px] text-[#4a4a5c] mt-3 mb-8">Honest, affordable pricing for every family budget.</p>
      ...
      <Section bg="bg-[#f2ede4]">
        <div className="text-center mb-10">
          ...
          <h2 className="font-['Playfair_Display',serif] font-bold text-[24px] sm:text-[32px] lg:text-[38px] leading-tight text-[#1a1a2e] mt-3">Built for Sivagangai Families</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <FeatureCard icon={<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M5 9L7.5 11.5L13 6" stroke="#D10B78" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="9" cy="9" r="7.25" stroke="#D10B78" strokeWidth="1.5"/></svg>} title="All School Grades" desc="From nursery through college — the right size and style for every stage." />
          <FeatureCard icon={<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M2 9H16M9 2V16" stroke="#D10B78" strokeWidth="1.5" strokeLinecap="round"/></svg>} title="Affordable Prices" desc="Kids collection starting from ₹149. Fair prices without compromising quality." />
          ...
          <FeatureCard icon={<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="7.25" stroke="#D10B78" strokeWidth="1.5"/><path d="M9 5.5V9L11.5 11" stroke="#D10B78" strokeWidth="1.5" strokeLinecap="round"/></svg>} title="Open Every Day" desc="Bring the kids in any day of the week. Let them choose what they love." />
        </div>
      </Section>
      ...
      <Section bg="bg-white">
        <div className="text-center mb-10">
          ...
          <h2 className="font-['Playfair_Display',serif] font-bold text-[24px] sm:text-[32px] lg:text-[38px] leading-tight text-[#1a1a2e] mt-3">Kids Collection FAQs</h2>
        </div>
