  ...
  return (
    <div>
      ...
      <Section bg="bg-white">
        ...
        <h2 className="font-['Playfair_Display',serif] font-bold text-[26px] sm:text-[36px] lg:text-[44px] leading-tight text-[#1a1a2e] mt-3">The Right Bag for Every School Stage</h2>
        <p className="font-['Inter',sans-serif] text-[14px] sm:text-[16px] leading-[27px] text-[#4a4a5c] mt-5 max-w-2xl">At Baji Footwear, we stock school bags that are sized and built for each stage of education. Our staff will guide you to the right capacity, weight and design for your child's specific school and grade.</p>
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-5">
          {FEATURES.map(({ title, desc }) => (
            <div key={title} className="bg-[#f2ede4] rounded-2xl p-6">
              <div className="w-8 h-8 rounded-full bg-[#d10b78] flex items-center justify-center mb-4">
      ...
      <Section bg="bg-[#f2ede4]">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-center">
          ...
          <div className="flex-1">
            ...
            <h2 className="font-['Playfair_Display',serif] font-bold text-[24px] sm:text-[34px] lg:text-[40px] leading-tight text-[#e40a7a] mt-3">Lightweight Designs. Durable Materials.</h2>
            <p className="font-['Inter',sans-serif] text-[14px] sm:text-[16px] leading-[27px] text-[#4a4a5c] mt-5">{"A school bag needs to survive rain, rough handling, heavy books and a full academic year. Baji Footwear's school bags are selected specifically for the demands of Sivagangai's school environment."}</p>
      ...
      <ParallaxBand img={imgStoreBags} className="py-12 sm:py-14" overlayOpacity={0.75}>
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 lg:px-10 text-center">
          <ScrollReveal>
            <p className="font-['Playfair_Display',serif] font-bold text-[22px] sm:text-[28px] text-white">School Bag Price Range in Sivagangai</p>
          </ScrollReveal>
        </div>
      </ParallaxBand>
      ...
      <Section bg="bg-white">
        ...
        <h2 className="font-['Playfair_Display',serif] font-bold text-[24px] sm:text-[34px] lg:text-[40px] leading-tight text-[#1a1a2e] mt-3">School Bag Price Range</h2>
        <p className="font-['Inter',sans-serif] text-[14px] sm:text-[15px] text-[#4a4a5c] mt-3 mb-8">Prices vary by size, design, brand and features. These are our current entry, mid and premium ranges.</p>
        ...
        <p className="mt-5 font-['Inter',sans-serif] text-[12px] sm:text-[13px] text-[#8a8a9a] italic">Prices valid at time of printing. WhatsApp us to confirm current availability and pricing.</p>
      </Section>
      ...
      <Section bg="bg-[#faf7f2]">
        <div className="text-center mb-10">
          ...
          <h2 className="font-['Playfair_Display',serif] font-bold text-[24px] sm:text-[34px] lg:text-[40px] leading-tight text-[#1a1a2e] mt-3">Trusted by Sivagangai Families</h2>
        </div>
        <StaggerGrid className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <FeatureCard icon={<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M2 9H16M9 2V16" stroke="#D10B78" strokeWidth="1.5" strokeLinecap="round"/></svg>} title="Fair, Honest Prices" desc="Starting from ₹349 with no hidden costs. Ask our staff before you buy." />
          <FeatureCard icon={<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M5 9L7.5 11.5L13 6" stroke="#D10B78" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="9" cy="9" r="7.25" stroke="#D10B78" strokeWidth="1.5"/></svg>} title="Staff Guidance" desc="Our team helps you pick the right size and weight for your child's school." />
          <FeatureCard icon={<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="7.25" stroke="#D10B78" strokeWidth="1.5"/><path d="M9 5.5V9L11.5 11" stroke="#D10B78" strokeWidth="1.5" strokeLinecap="round"/></svg>} title="Open 7 Days" desc="Shop at your convenience. Open every day including Sunday." />
        </StaggerGrid>
      </Section>
      ...
      <Section bg="bg-[#f2ede4]">
        <div className="text-center mb-10">
          ...
          <h2 className="font-['Playfair_Display',serif] font-bold text-[24px] sm:text-[32px] lg:text-[38px] leading-tight text-[#1a1a2e] mt-3">School Bag FAQs</h2>
        </div>
